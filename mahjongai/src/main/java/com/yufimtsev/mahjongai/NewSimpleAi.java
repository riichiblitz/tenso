...
public class NewSimpleAi {
    ...
    public NewSimpleAi(ArrayList<Integer> startHand, int interestLevel) {
        // tiles in range [1...34]
    ...
    public NewSimpleAi(int[][] hands, String startHand, int interestLevel) {
